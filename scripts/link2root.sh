...
openldisk_SH=$SCRIPT_DIR/openldisk.sh
StephanWareOpen=$SCRIPT_DIR/StephanWareOpen.sh
TEXT_DIR=$DISK1/text
...
WifiADB_TXT=$SCRIPT_DIR/adb-sh/wifiadb.sh
####################### initial variables #######################################
...
ln -s $openldisk_SH $root
echo "Link to File : openldisk.sh created Successfully"
ln -s $StephanWareOpen $root
ln -s $WifiADB_TXT $root
echo 'Link to File : WifiADB.sh Created Successfully'
ln -s $Apt_TXT $root
echo 'Link to File: apt Created Successfully'
ln -s $Path_TXT $root
echo 'Link to file: path created Successfully'
...
echo "StephanWareOpen.sh   |     SCRIPT"
echo "openldisk.sh         |     SCRIPT" 
echo "apt                  |     TEXT"
echo "scripts              |     DIR"
echo "wifiADB.sh           |     SCRIPT"
